...
<div class="d-flex">
	...
	<div class="w-100 ml-5">
		<h3 class="font-weight-bold">후기 작성</h3>
		...
		<div class="d-flex justify-content-between mt-5 mr-5">
			...
			<textarea id="review" class="form-control col-10" rows="5"></textarea>
		</div>
		
		<div class="d-flex justify-content-end mt-5 mr-5">
			<button type="button" id="reviewAddBtn" class="btn btn-secondary" data-purchase-product-id="${purchaseProductCardView.purchaseProduct.id}">작성하기</button>
		</div>
	</div>
</div>
...
<script>
	$(document).ready(function() {
		...
		$('#reviewAddBtn').on('click', function() {
			...
			$.ajax({
				type:"PUT"
				, url:"/purchase/product_review_create"
				, data:formData
				// 파일 업로드를 위한 필수 설정

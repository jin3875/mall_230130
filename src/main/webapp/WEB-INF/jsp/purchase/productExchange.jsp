...
<div class="d-flex">
	...
	<div class="w-100 ml-5">
		...
		<div class="d-flex justify-content-end mt-5 mr-5">
			<button type="button" id="exchangeBtn" class="btn btn-secondary" data-purchase-product-id="${purchaseProductView.purchaseProduct.id}" data-product-id="${purchaseProductView.product.id}">신청하기</button>
		</div>
	</div>
</div>

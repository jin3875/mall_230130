...
<div class="input-big-box d-flex justify-content-between">
	...
	<div class="input-small-box">
		...
		<div class="d-flex justify-content-between align-items-center mt-3">
			<span>사이즈</span>
			<input type="text" id="size" class="form-control col-8" value="${productDetail.size}">
		</div>
		...
		<div class="d-flex justify-content-between align-items-center mt-3">
			<span>재고 수량</span>
			<input type="text" id="amount" class="form-control col-8" value="${productDetail.amount}">
		</div>
...
<script>
	$(document).ready(function() {
		...
		$('#editBtn').on('click', function() {
			...
			$.ajax({
				type:"PUT"
				, url:"/admin/admin_detail_update"
				, data:{"detailId":detailId, "color":color, "size":size, "amount":amount}

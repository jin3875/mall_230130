	...
	<tbody>
		<c:forEach var="purchaseCardView" items="${purchaseCardViewList}">
			<tr>
				...
				<td class="align-middle"><a href="/admin/admin_sale_view?purchaseId=${purchaseCardView.purchase.id}" class="btn btn-sm btn-outline-success">정보</a></td>
				<td class="align-middle"><a href="/admin/admin_sale_detail_list_view?purchaseId=${purchaseCardView.purchase.id}" class="btn btn-sm btn-outline-info">목록</a></td>
			</tr>
		</c:forEach>
	</tbody>
</table>